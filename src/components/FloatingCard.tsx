...
export function FloatingCard({
  ...
  return (
    // outer layer: one-time entrance only (Framer stops once this settles)
    <motion.div
      ...
      className={className}
    >
      {/* middle layer: perpetual idle bob, pure CSS so it costs nothing
          on the JS thread while scrolling */}
      <div
