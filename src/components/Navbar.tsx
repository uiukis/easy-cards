        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="bg-halftone fixed inset-y-0 right-0 z-50 flex w-72 max-w-[82vw] flex-col overflow-y-auto border-l-2 border-ink/10 bg-surface px-5 py-5 shadow-2xl md:hidden"
            >
